...
import com.example.lenovo_pc.monashfriendfinder.util.Forecast;
...
public class HomeActivity extends AppCompatActivity implements View.OnClickListener, Runnable {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        testtextview = (TextView)findViewById(R.id.profile);
        initview();
...
//        });
    ...
    private void initview(){
            yes_date = (TextView)findViewById(R.id.yesterday_date);
            yes_fl = (TextView) findViewById(R.id.yesterday_fengli);
            yes_fx = (TextView)findViewById(R.id.yesterday_fengxiang);
            yes_high = (TextView)findViewById(R.id.yesterday_high);
            yes_low = (TextView)findViewById(R.id.yesterday_low);
            yes_type = (TextView)findViewById(R.id.yesterday_type);
            fore1_date = (TextView)findViewById(R.id.fore1_date);
        fore1_date = (TextView)findViewById(R.id.fore1_date);
        fore1_fl = (TextView)findViewById(R.id.fore1_fengli);
        fore1_fx = (TextView)findViewById(R.id.fore1_fengxiang);
        fore1_high = (TextView)findViewById(R.id.fore1_high);
        fore1_low = (TextView)findViewById(R.id.fore1_low);
        fore1_type = (TextView)findViewById(R.id.fore1_type);
        fore2_date = (TextView)findViewById(R.id.fore2_date);
        fore2_fl = (TextView)findViewById(R.id.fore2_fengli);
        fore2_fx = (TextView)findViewById(R.id.fore2_fengxiang);
        fore2_high = (TextView)findViewById(R.id.fore2_high);
        fore2_low = (TextView)findViewById(R.id.fore2_low);
        fore2_type = (TextView)findViewById(R.id.fore2_type);

        fore3_date = (TextView)findViewById(R.id.fore3_date);
        fore3_fl = (TextView)findViewById(R.id.fore3_fengli);
        fore3_fx = (TextView)findViewById(R.id.fore3_fengxiang);
        fore3_high = (TextView)findViewById(R.id.fore3_high);
        fore3_low = (TextView)findViewById(R.id.fore3_low);
        fore3_type = (TextView)findViewById(R.id.fore3_type);

        fore4_date = (TextView)findViewById(R.id.fore4_date);
        fore4_fl = (TextView)findViewById(R.id.fore4_fengli);
        fore4_fx = (TextView)findViewById(R.id.fore4_fengxiang);
        fore4_high = (TextView)findViewById(R.id.fore4_high);
        fore4_low = (TextView)findViewById(R.id.fore4_low);
        fore4_type = (TextView)findViewById(R.id.fore4_type);

        fore5_date = (TextView)findViewById(R.id.fore5_date);
        fore5_fl = (TextView)findViewById(R.id.fore5_fengli);
        fore5_fx = (TextView)findViewById(R.id.fore5_fengxiang);
        fore5_high = (TextView)findViewById(R.id.fore5_high);
        fore5_low = (TextView)findViewById(R.id.fore5_low);
        fore5_type = (TextView)findViewById(R.id.fore5_type);
        SharedPreferencesUtils profile = new SharedPreferencesUtils(this,"setting");
