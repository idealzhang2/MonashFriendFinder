...
import com.example.lenovo_pc.monashfriendfinder.R;
import com.example.lenovo_pc.monashfriendfinder.SharedPreferencesUtils;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        map.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(LoginAfterActivity.this,RegisterActivity.class));
